...
## Environments
- Preview: https://main--gen-xwalk-started--singhpritam18.aem.page/
- Live: https://main--gen-xwalk-started--singhpritam18.aem.live/
...
1. Open the `gen-xwalk-started` directory in your favorite IDE and start coding :)
